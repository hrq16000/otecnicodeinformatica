...
const data = {
  ...
  cidade: "Araucária",
  metaTitle: "Técnico de Informática no São Miguel | Araucária | Técnico Curitiba",
  metaDescription: "Técnico de informática no São Miguel, Araucária. Atendimento a domicílio com diagnóstico no local. Formatação, conserto de notebook, redes Wi-Fi. A partir de R$ 69,99.",
