...
const data = {
  ...
  slug: "campo-pequeno",
  cidade: "Colombo",
  metaTitle: "Técnico de Informática no Campo Pequeno | Colombo | Atendimento a Domicílio | O Técnico de Informática",
  metaDescription: "Técnico de informática no Campo Pequeno, Colombo. Formatação, conserto de notebook, remoção de vírus, upgrade SSD. Atendimento a domicílio rápido. a partir de R$ 99,99.",
  h1: "Técnico de Informática no Campo Pequeno – Colombo",
  subtitulo: "Atendimento técnico profissional a domicílio no Campo Pequeno. Diagnóstico no local, valor transparente e garantia.",
