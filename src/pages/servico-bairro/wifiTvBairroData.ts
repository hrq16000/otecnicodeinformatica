...
export function buildTvBairroData(bairroSlug: string): ServicoBairroData {
  ...
  return {
    ...
    processoPasso: [
      ...
      { titulo: "valor do atendimento e aprovação", descricao: "Enviamos o valor por escrito. Nada é executado sem sua aprovação." },
    ...
    faq: [
      ...
      { pergunta: "Qual o prazo?", resposta: "O prazo padrão é de 3 a 10 dias úteis conforme a disponibilidade de peças. Informamos o prazo estimado junto do valor do atendimento." },
    ],
    pontosReferencia: b.pontosReferencia,
    tempoAtendimento: b.tempoAtendimento,
    servicosRelacionados: [
