...
const benefits = [
  ...
  { icon: Shield, title: "Técnico Experiente", description: "Mais de 10 anos. Profissional identificado com ferramentas profissionais." },
      ...
      <main>
        ...
        <section className="py-12 md:py-16 bg-secondary">
          <div className="container mx-auto"><div className="max-w-4xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold text-primary mb-6 text-center">Assistência Técnica em Campo Magro</h2>
            ...
            <div className="grid sm:grid-cols-3 gap-4 mt-8">
              ...
              <div className="bg-background rounded-lg p-4 text-center border border-border"><Building2 className="h-8 w-8 text-accent mx-auto mb-2" /><h3 className="font-semibold text-foreground">Comércios</h3><p className="text-sm text-muted-foreground">Suporte para negócios locais</p></div>
        ...
        <section className="py-12 md:py-16 bg-secondary">
          <div className="container mx-auto"><div className="max-w-4xl mx-auto">
            <h2 className="text-2xl font-bold text-primary mb-8 text-center">Serviços em Campo Magro</h2>
