...
const data = {
  ...
  metaDescription: "Técnico de informática no Jardim Estados, Fazenda Rio Grande. Formatação, conserto de notebook, remoção de vírus, upgrade SSD. Atendimento a domicílio. A partir de R$ 69,99.",
