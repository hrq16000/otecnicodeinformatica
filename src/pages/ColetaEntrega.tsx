...
const faqItems = [
  ...
  { q: "O reparo é executado direto?", a: "Não. Após o recebimento fazemos o diagnóstico e a execução só acontece depois da sua aprovação do valor do atendimento. Peças e componentes, quando necessários, ficam fora do valor-base." },
          ...
          <div className="container mx-auto">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-0">
                {[
                  { icon: Phone, title: "1. Contato Inicial", desc: `Você descreve o problema via WhatsApp. O técnico faz uma estimativa gratuita e informa as condições. valor do atendimento preciso somente com compromisso (taxa mínima ${COLETA_TAXA_MINIMA_LABEL} pré-aprovada).` },
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="bg-secondary rounded-2xl p-6 md:p-8 border-2 border-accent/20 text-center">
                <p className="text-muted-foreground mb-4">
                  A coleta e entrega está <strong className="text-accent">inclusa no valor do reparo</strong> quando o serviço é aprovado. {REGRA_ORCAMENTO_GRATIS}. valor do atendimento preciso somente com compromisso.
                </p>
