...
const data = {
  ...
  metaDescription: "Técnico de informática no Pioneiros, Fazenda Rio Grande. Formatação, conserto de notebook, remoção de vírus, upgrade SSD. Atendimento a domicílio. A partir de R$ 69,99.",
  h1: "Técnico de Informática no Pioneiros – Fazenda Rio Grande",
  subtitulo: "Atendimento técnico profissional a domicílio no Pioneiros. Diagnóstico no local, orçamento transparente e garantia.",
  descricaoLonga: `O Pioneiros faz parte de Fazenda Rio Grande, cidade ao sul de Curitiba com crescimento acelerado. A região tem forte demanda por serviços de informática profissional. Nosso técnico de informática atende o Pioneiros a domicílio com equipamento profissional, realizando diagnóstico no local e resolvendo a maioria dos problemas na primeira visita. Para casos que exigem bancada, oferecemos coleta e entrega. Trabalhamos com transparência total: orçamento antes da execução, sem surpresas.`,
