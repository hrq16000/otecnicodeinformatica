...
const data = {
  ...
  metaDescription: "Técnico de informática no Gabirobal, Colombo. Formatação, conserto de notebook, remoção de vírus, upgrade SSD. Atendimento a domicílio rápido. A partir de R$ 69,99.",
  h1: "Técnico de Informática no Gabirobal – Colombo",
  subtitulo: "Atendimento técnico profissional a domicílio no Gabirobal. Diagnóstico no local, orçamento transparente e garantia.",
