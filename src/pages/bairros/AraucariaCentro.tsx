...
const AraucariaCentro = () => {
  const data = {
    ...
    metaDescription:
      "Técnico de informática no Centro de Araucária. Formatação, conserto de notebook/PC, remoção de vírus e upgrade SSD. Atendimento a domicílio com agendamento. Visita a partir de R$ 99,99.",
