...
const data = {
  ...
  metaDescription: "Técnico de informática no Jardim Social, Curitiba. Atendimento a domicílio com diagnóstico no local. Formatação, conserto de notebook, redes Wi-Fi. A partir de R$ 69,99.",
