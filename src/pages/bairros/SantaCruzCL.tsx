...
const data = {
  ...
  metaDescription: "Técnico de informática no Santa Cruz, Campo Largo. Formatação, conserto de notebook, remoção de vírus, upgrade SSD. Atendimento a domicílio. A partir de R$ 69,99.",
  h1: "Técnico de Informática no Santa Cruz – Campo Largo",
  subtitulo: "Atendimento técnico profissional a domicílio no Santa Cruz. Diagnóstico no local, orçamento transparente e garantia.",
  descricaoLonga: `O Santa Cruz é uma região de Campo Largo, a Capital da Louça, com perfil residencial e comercial. Moradores e empresas locais precisam de suporte técnico rápido e confiável. Nosso técnico de informática atende o Santa Cruz a domicílio com equipamento profissional, realizando diagnóstico no local e resolvendo a maioria dos problemas na primeira visita. Para casos que exigem bancada, oferecemos coleta e entrega. Trabalhamos com transparência total: orçamento antes da execução, sem surpresas.`,
