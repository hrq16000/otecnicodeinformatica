...
const data = {
  ...
  slug: "cajuru",
  cidade: "Curitiba",
  metaTitle: "Técnico de Informática no Cajuru | Curitiba | Atendimento a Domicílio | O Técnico de Informática",
  ...
  subtitulo: "Atendimento técnico profissional a domicílio no Cajuru. Diagnóstico no local, valor transparente e garantia.",
