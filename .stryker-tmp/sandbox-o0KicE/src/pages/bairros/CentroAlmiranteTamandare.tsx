...
Atendemos o Centro com todos os serviços de informática: formatação, remoção de vírus, upgrade de hardware, conserto de notebook e configuração de rede. Diagnóstico no local, valor antes da execução e garantia por escrito.`,
