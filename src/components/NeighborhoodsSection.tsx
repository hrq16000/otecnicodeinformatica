      ...
      <div className="container mx-auto relative z-10">
          ...
          {neighborhoods.map((neighborhood, index) => (
            neighborhood.hasPage ? (
              <Link
                ...
                className="flex items-center gap-1.5 bg-background px-3.5 py-2 rounded-full text-sm border border-primary/10 hover:border-accent hover:bg-accent/5 hover:scale-110 hover:-translate-y-0.5 hover:shadow-[var(--shadow-md)] transition-all duration-300 group stagger-item"
              ...
              <div
                key={neighborhood.slug}
                className="flex items-center gap-1.5 bg-background px-3.5 py-2 rounded-full text-sm border border-primary/10 hover:border-primary/30 hover:bg-background/80 transition-all duration-300 stagger-item"
                style={{ animationDelay: `${index * 30}ms` }}
              >
        ...
        <div className="text-center mt-8">
          <Link 
            ...
            className="inline-flex items-center gap-2 text-accent hover:gap-3 font-semibold transition-all duration-200 link-underline"
          >
