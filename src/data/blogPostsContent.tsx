  ...
  "organizacao-de-ti-para-pequenos-escritorios": {
    ...
    content: (
      <>
        ...
        <p>Chamado bem descrito reduce ida e volta. Antes de acionar suporte, anote qual equipamento e qual pessoa foram afetados, o horário aproximado do início, a mensagem de erro exata, o programa envolvido, qualquer alteração recente, quantas pessoas estão paradas e se o acesso remoto é possível. Nunca envie senhas ou códigos de autenticação por mensagem.</p>
