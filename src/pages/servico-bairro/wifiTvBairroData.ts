...
export function buildWifiBairroData(bairroSlug: string): ServicoBairroData {
  ...
  return {
    metaTitle: `Configuração de Wi-Fi no ${b.nome}, Curitiba a partir de R$ 99,99 | O Técnico de Informática`,
...
export function buildTvBairroData(bairroSlug: string): ServicoBairroData {
  ...
  const narrativa = b.narrativaLocal ? ` ${b.narrativaLocal}` : "";
  return {
    metaTitle: `Conserto de Smart TV no ${b.nome}, Curitiba com coleta e entrega | O Técnico de Informática`,
