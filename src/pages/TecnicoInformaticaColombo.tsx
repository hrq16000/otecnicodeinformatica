...
const benefits = [
  ...
  },
  {
    ...
    description: "Mais de 10 anos de experiência. Profissional credenciado com equipamento profissional.",
  },
  {
    icon: Wrench,
...
const bairros = [
  ...
  { name: "Alto Maracanã", slug: "alto-maracana", hasPage: false },
  { name: "Atuba", slug: "atuba-colombo", hasPage: false },
  { name: "Campo Pequeno", slug: "campo-pequeno", hasPage: false },
  { name: "Fátima", slug: "fatima-colombo", hasPage: false },
  { name: "Gabirobal", slug: "gabirobal", hasPage: false },
  { name: "Jardim Osasco", slug: "jardim-osasco", hasPage: false },
  { name: "Monza", slug: "monza-colombo", hasPage: false },
  { name: "Palmital", slug: "palmital-colombo", hasPage: false },
  { name: "Roça Grande", slug: "roca-grande", hasPage: false },
  { name: "São Gabriel", slug: "sao-gabriel-colombo", hasPage: false },
  { name: "Santa Terezinha", slug: "santa-terezinha-colombo", hasPage: false },
];
          ...
          <div className="container mx-auto">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="text-center mt-8">
                <Link to="/servicos" className="inline-flex items-center gap-2 text-accent hover:underline font-medium">
                  Ver todos os serviços disponíveis <ArrowRight className="h-4 w-4" />
                </Link>
              </div>
            </div>
          </div>
