...
const data = {
  ...
  metaDescription: "Técnico de informática no Tarumã, Curitiba. Atendimento a domicílio com diagnóstico no local. Formatação, conserto de notebook, redes Wi-Fi. A partir de R$ 69,99.",
