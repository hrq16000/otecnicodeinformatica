...
const data = {
  ...
  cidade: "Campo Largo",
  metaTitle: "Técnico de Informática no Jardim Novo Horizonte | Campo Largo | O Técnico de Informática",
...
const JardimNovoHorizonteCL = () => <BairroTemplate data={data} />;

export default JardimNovoHorizonteCL;
