...
const CFTVLitoral = () => (
  <CFTVCityTemplate
    ...
    metaDescription="Instalação de câmeras de segurança no Litoral do Paraná: Itapoá, Guaratuba e região. Kit 4 câmeras Intelbras com acesso remoto. R$ 1.350. WhatsApp."
