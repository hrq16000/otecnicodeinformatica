...
const data = {
  ...
  cidade: "Araucária",
  metaTitle: "Técnico de Informática no Vila Nova | Araucária | Técnico Curitiba",
  metaDescription: "Técnico de informática no Vila Nova, Araucária. Atendimento a domicílio com diagnóstico no local. Formatação, conserto de notebook, redes Wi-Fi. A partir de R$ 69,99.",
