...
const benefits = [
  ...
  },
  {
    ...
    description: "Mais de 20 anos de experiência em assistência técnica. Profissional identificado e credenciado.",
  },
  {
    icon: Wrench,
...
const TecnicoInformaticaAlmiranteTamandare = () => {
  useEffect(() => {
    document.title = "Técnico de Informática em Almirante Tamandaré | Atendimento Domicílio | Técnico Curitiba";
    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="py-12 md:py-16 bg-background">
          <div className="container mx-auto">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-2xl md:text-3xl font-bold text-primary mb-6 text-center">Bairros Atendidos</h2>
        ...
        <section className="py-12 md:py-16 bg-secondary">
          <div className="container mx-auto">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-2xl md:text-3xl font-bold text-primary mb-8 text-center">Serviços em Almirante Tamandaré</h2>
