...
const data = {
  ...
  metaDescription: "Técnico de informática no Pinheirinho, Curitiba. Formatação, conserto de notebook, remoção de vírus, upgrade SSD. Atendimento a domicílio rápido. A partir de R$ 69,99.",
  h1: "Técnico de Informática no Pinheirinho – Curitiba",
  subtitulo: "Atendimento técnico profissional a domicílio no Pinheirinho. Diagnóstico no local, orçamento transparente e garantia.",
