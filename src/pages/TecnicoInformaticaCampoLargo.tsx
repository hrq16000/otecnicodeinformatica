...
const bairros = [
  ...
  { name: "Jardim América", slug: "jardim-america-campo-largo", hasPage: true },
  { name: "Botiatuva", slug: "botiatuva", hasPage: true },
  { name: "Rondinha", slug: "rondinha", hasPage: true },
  { name: "São Silvestre", slug: "sao-silvestre", hasPage: true },
  { name: "Três Córregos", slug: "tres-corregos", hasPage: true },
  { name: "Itaqui", slug: "itaqui", hasPage: true },
  { name: "Ouro Fino", slug: "ouro-fino", hasPage: true },
  { name: "Bateias", slug: "bateias", hasPage: true },
  { name: "Palmital", slug: "palmital-campo-largo", hasPage: true },
  { name: "Santa Cruz", slug: "santa-cruz-campo-largo", hasPage: true },
