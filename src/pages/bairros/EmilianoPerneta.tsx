...
const data = {
  ...
  cidade: "Pinhais",
  metaTitle: "Técnico de Informática no Emiliano Perneta | Pinhais | Atendimento Domicílio | O Técnico de Informática",
  ...
  subtitulo: "Atendimento técnico profissional a domicílio no Emiliano Perneta. Diagnóstico no local, valor transparente e garantia.",
  descricaoLonga: `O Emiliano Perneta é um bairro de Pinhais, cidade vizinha de Curitiba com acesso rápido pela região norte/leste. Com forte perfil residencial, o bairro conta com demanda constante por serviços de informática. Nosso técnico de informática atende o Emiliano Perneta a domicílio com equipamento profissional, realizando diagnóstico no local e resolvendo a maioria dos problemas na primeira visita. Para casos que exigem bancada, oferecemos coleta e entrega. Trabalhamos com transparência total: Valor antes da execução, sem surpresas.`,
