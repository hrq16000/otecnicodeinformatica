...
const CFTVCuritiba = () => (
  <CFTVCityTemplate
    city="Curitiba"
    slug="curitiba"
    metaTitle="Câmeras de Segurança em Curitiba | Kit 4 Câmeras Intelbras R$ 1.350 | Instalação Profissional"
    metaDescription="Instalação de câmeras de segurança Intelbras em Curitiba. Kit 4 câmeras com DVR, HD e acesso remoto por R$ 1.350. Desde 1999. WhatsApp (41) 99745-2053."
