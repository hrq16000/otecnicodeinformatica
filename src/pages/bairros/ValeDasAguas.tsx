...
const data = {
  ...
  metaDescription: "Técnico de informática no Vale das Águas, Pinhais. Formatação, conserto de notebook, remoção de vírus, upgrade SSD. Atendimento a domicílio. A partir de R$ 69,99.",
  h1: "Técnico de Informática no Vale das Águas – Pinhais",
  subtitulo: "Atendimento técnico profissional a domicílio no Vale das Águas. Diagnóstico no local, orçamento transparente e garantia.",
  descricaoLonga: `O Vale das Águas é um bairro de Pinhais, cidade vizinha de Curitiba com acesso rápido pela região norte/leste. Com forte perfil residencial, o bairro conta com demanda constante por serviços de informática. Nosso técnico de informática atende o Vale das Águas a domicílio com equipamento profissional, realizando diagnóstico no local e resolvendo a maioria dos problemas na primeira visita. Para casos que exigem bancada, oferecemos coleta e entrega. Trabalhamos com transparência total: orçamento antes da execução, sem surpresas.`,
