...
export const bairroFAQs: Record<string, GeoFAQ[]> = {
  ...
  "batel": [
    {
      ...
      answer: "A formatação de notebook no Batel parte de R$ 99,99 (30 minutos). O valor final depende da complexidade: backup de dados, instalação de programas específicos, etc. Orçamento sem compromisso."
    },
    {
  ...
  "cic": [
    ...
    },
    {
      ...
      answer: "O deslocamento já está incluso no valor da visita técnica (R$ 99,99 por 30 min). Não cobramos taxa extra para atendimento na CIC."
    }
  ],
  ...
  "centro-araucaria": [
    ...
    },
    {
      ...
      answer: "O valor é o mesmo: R$ 99,99 para os primeiros 30 minutos. Não cobramos taxa extra de deslocamento para Araucária."
    },
    {
