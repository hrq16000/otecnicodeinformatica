...
const data = {
  ...
  subtitulo: "Atendimento técnico profissional a domicílio no Jardim Menino Deus. Diagnóstico no local, orçamento transparente e garantia.",
  descricaoLonga: `O Jardim Menino Deus é um bairro de Quatro Barras, cidade ao nordeste de Curitiba com acesso pela BR-116. Com perfil residencial e crescimento constante, a demanda por suporte técnico é cada vez maior. Nosso técnico de informática atende o Jardim Menino Deus a domicílio com equipamento profissional, realizando diagnóstico no local e resolvendo a maioria dos problemas na primeira visita. Para casos que exigem bancada, oferecemos coleta e entrega. Trabalhamos com transparência total: orçamento antes da execução, sem surpresas.`,
