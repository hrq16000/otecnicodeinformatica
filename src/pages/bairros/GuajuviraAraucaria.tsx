...
const data = {
  ...
  metaDescription: "Técnico de informática no Guajuvira, Araucária. Formatação, conserto de notebook, remoção de vírus, upgrade SSD. Atendimento a domicílio rápido. A partir de R$ 69,99.",
  h1: "Técnico de Informática no Guajuvira – Araucária",
  subtitulo: "Atendimento técnico profissional a domicílio no Guajuvira. Diagnóstico no local, orçamento transparente e garantia.",
