...
const data = {
  ...
  slug: "boqueirao",
  cidade: "Curitiba",
  metaTitle: "Técnico de Informática no Boqueirão | Curitiba | Atendimento a Domicílio | O Técnico de Informática",
  metaDescription: "Técnico de informática no Boqueirão, Curitiba. Formatação, conserto de notebook, remoção de vírus, upgrade SSD. Atendimento a domicílio rápido. a partir de R$ 99,99.",
