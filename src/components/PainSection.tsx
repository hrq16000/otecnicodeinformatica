        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-8 max-w-2xl mx-auto">
            {benefits.map((benefit, index) => (
              <div 
                key={index}
                className="flex items-start gap-3 bg-card rounded-xl px-4 py-4 shadow-[var(--shadow-sm)] hover:shadow-[var(--shadow-md)] border border-border/50 text-left hover-lift anim-fade-up ripple-container transition-all duration-300"
