...
const data = {
  ...
  cidade: "Araucária",
  metaTitle: "Técnico de Informática no Porto das Laranjeiras | Araucária | Atendimento a Domicílio | O Técnico de Informática",
  ...
  subtitulo: "Atendimento técnico profissional a domicílio no Porto das Laranjeiras. Diagnóstico no local, valor transparente e garantia.",
