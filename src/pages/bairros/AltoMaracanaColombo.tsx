...
const data = {
  ...
  slug: "alto-maracana",
  cidade: "Colombo",
  metaTitle: "Técnico de Informática no Alto Maracanã | Colombo | Atendimento a Domicílio | Técnico Curitiba",
  metaDescription: "Técnico de informática no Alto Maracanã, Colombo. Formatação, conserto de notebook, remoção de vírus, upgrade SSD. Atendimento a domicílio rápido. A partir de R$ 69,99.",
  h1: "Técnico de Informática no Alto Maracanã – Colombo",
  subtitulo: "Atendimento técnico profissional a domicílio no Alto Maracanã. Diagnóstico no local, orçamento transparente e garantia.",
