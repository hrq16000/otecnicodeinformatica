...
const data = {
  ...
  descricaoLonga: `O Colônia Antônio Prado é um bairro de Almirante Tamandaré, ao norte de Curitiba. Com perfil residencial e crescimento constante, a comunidade local precisa de assistência técnica confiável. Nosso técnico de informática atende o Colônia Antônio Prado a domicílio com equipamento profissional, realizando diagnóstico no local e resolvendo a maioria dos problemas na primeira visita. Para casos que exigem bancada, oferecemos coleta e entrega. Trabalhamos com transparência total: valor antes da execução, sem surpresas.`,
...
const ColoniaAntonioPradoAT = () => <BairroTemplate data={data} />;

export default ColoniaAntonioPradoAT;
