...
const data = {
  ...
  metaDescription: "Técnico de informática no São Venâncio, Almirante Tamandaré. Formatação, conserto de notebook, remoção de vírus, upgrade SSD. Atendimento a domicílio. A partir de R$ 69,99.",
