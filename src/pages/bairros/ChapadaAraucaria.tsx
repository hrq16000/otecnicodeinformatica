...
const data = {
  ...
  slug: "chapada",
  cidade: "Araucária",
  metaTitle: "Técnico de Informática no Chapada | Araucária | Atendimento a Domicílio | Técnico Curitiba",
  metaDescription: "Técnico de informática no Chapada, Araucária. Formatação, conserto de notebook, remoção de vírus, upgrade SSD. Atendimento a domicílio rápido. A partir de R$ 69,99.",
