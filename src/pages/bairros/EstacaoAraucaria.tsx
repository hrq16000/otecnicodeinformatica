...
const data = {
  ...
  metaDescription: "Técnico de informática no Estação, Araucária. Formatação, conserto de notebook, remoção de vírus, upgrade SSD. Atendimento a domicílio rápido. A partir de R$ 69,99.",
  h1: "Técnico de Informática no Estação – Araucária",
  subtitulo: "Atendimento técnico profissional a domicílio no Estação. Diagnóstico no local, orçamento transparente e garantia.",
