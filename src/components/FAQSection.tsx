...
const faqs: FAQItem[] = [
  {
    ...
    answer: "O valor da visita técnica começa em R$ 99,99 para os primeiros 30 minutos de atendimento. O orçamento é feito no local e você só paga se aprovar o serviço. Aceitamos PIX, cartão de crédito, débito e dinheiro. Não cobramos taxa de deslocamento dentro de Curitiba e região metropolitana."
  },
  {
          ...
          {faqs.map((faq, index) => (
            ...
            >
              <button
                ...
                className="w-full py-5 flex items-start justify-between gap-4 text-left hover:bg-muted/30 transition-colors px-4 -mx-4 rounded-lg"
