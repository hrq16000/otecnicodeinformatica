...
const data = {
  ...
  descricaoLonga: `O Borda do Campo é um bairro de Quatro Barras, cidade ao nordeste de Curitiba com acesso pela BR-116. Com perfil residencial e crescimento constante, a demanda por suporte técnico é cada vez maior. Nosso técnico de informática atende o Borda do Campo a domicílio com equipamento profissional, realizando diagnóstico no local e resolvendo a maioria dos problemas na primeira visita. Para casos que exigem bancada, oferecemos coleta e entrega. Trabalhamos com transparência total: Valor antes da execução, sem surpresas.`,
