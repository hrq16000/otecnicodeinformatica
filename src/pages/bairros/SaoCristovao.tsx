...
const SaoCristovao = () => {
  const data = {
    ...
    metaDescription: "Técnico de informática no São Cristóvão, São José dos Pinhais. Conserto de PC e notebook, formatação, upgrade. Atendimento domiciliar. R$ 99,99.",
