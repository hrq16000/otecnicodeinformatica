...
const Braga = () => {
  const data = {
    ...
    metaDescription: "Técnico de informática no bairro Braga em São José dos Pinhais. Manutenção, conserto de PC e notebook. Atendimento em domicílio. A partir de R$ 69,99.",
