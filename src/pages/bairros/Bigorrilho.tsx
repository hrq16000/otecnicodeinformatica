...
const data = {
  ...
  metaDescription: "Técnico de informática no Bigorrilho, Curitiba. Formatação, conserto de notebook, remoção de vírus, upgrade SSD. Atendimento a domicílio rápido. A partir de R$ 69,99.",
  h1: "Técnico de Informática no Bigorrilho – Curitiba",
  subtitulo: "Atendimento técnico profissional a domicílio no Bigorrilho. Diagnóstico no local, orçamento transparente e garantia.",
