...
const data: ServicoBairroData = {
  ...
  metaDescription: "Remoção de vírus e malware no Centro de Curitiba. Limpeza completa, proteção avançada e antivírus profissional. Atendimento no mesmo dia. A partir de R$ 79,99.",
