...
const CFTVPage = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <PageSEO title="Kit 4 Câmeras de Segurança Intelbras | Instalação Profissional em Curitiba e Região | R$ 1.350" description="Kit 4 Câmeras Intelbras com instalação profissional inclusa e acesso remoto pelo celular. R$ 1.350 completo. Atendemos Curitiba, São José dos Pinhais, Itapoá e Guaratuba. Desde 1999. WhatsApp (41) 99745-2053." path="/cftv" />
      {/* JSON-LD */}
