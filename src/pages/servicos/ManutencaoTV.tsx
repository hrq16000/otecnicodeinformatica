...
const ManutencaoTV = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <PageSEO title="Manutenção e Conserto de TV em Curitiba | LED, LCD, Smart TV | Técnico Curitiba" description="Conserto de TV LED, LCD e Smart TV em Curitiba. Diagnóstico em bancada, reparo de placa, fonte e backlight. Coleta e entrega. Técnico com experiência." path="/servicos/manutencao-t-v"  breadcrumbs={[
        { name: "Início", path: "/" },
