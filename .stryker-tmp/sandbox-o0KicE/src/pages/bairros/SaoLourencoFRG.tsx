...
const data = {
  ...
  metaTitle: "Técnico de Informática no São Lourenço | Fazenda Rio Grande | Atendimento Domicílio | O Técnico de Informática",
  ...
  descricaoLonga: `O São Lourenço faz parte de Fazenda Rio Grande, cidade ao sul de Curitiba com crescimento acelerado. A região tem forte demanda por serviços de informática profissional. Nosso técnico de informática atende o São Lourenço a domicílio com equipamento profissional, realizando diagnóstico no local e resolvendo a maioria dos problemas na primeira visita. Para casos que exigem bancada, oferecemos coleta e entrega. Trabalhamos com transparência total: Valor antes da execução, sem surpresas.`,
