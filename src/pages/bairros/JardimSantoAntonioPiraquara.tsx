...
const data = {
  ...
  cidade: "Piraquara",
  metaTitle: "Técnico de Informática no Jardim Santo Antônio | Piraquara | Técnico Curitiba",
  metaDescription: "Técnico de informática no Jardim Santo Antônio, Piraquara. Atendimento a domicílio com diagnóstico no local. Formatação, conserto de notebook, redes Wi-Fi. A partir de R$ 69,99.",
