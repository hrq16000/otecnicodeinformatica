...
const data = {
  ...
  slug: "jardim-osasco",
  cidade: "Colombo",
  metaTitle: "Técnico de Informática no Jardim Osasco | Colombo | Atendimento a Domicílio | O Técnico de Informática",
  metaDescription: "Técnico de informática no Jardim Osasco, Colombo. Formatação, conserto de notebook, remoção de vírus, upgrade SSD. Atendimento a domicílio rápido. a partir de R$ 99,99.",
  h1: "Técnico de Informática no Jardim Osasco – Colombo",
  subtitulo: "Atendimento técnico profissional a domicílio no Jardim Osasco. Diagnóstico no local, valor transparente e garantia.",
