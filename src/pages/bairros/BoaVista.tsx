...
const data = {
  ...
  metaDescription: "Técnico de informática no Boa Vista, Curitiba. Formatação, conserto de notebook, remoção de vírus, upgrade SSD. Atendimento a domicílio rápido. A partir de R$ 69,99.",
  h1: "Técnico de Informática no Boa Vista – Curitiba",
  subtitulo: "Atendimento técnico profissional a domicílio no Boa Vista. Diagnóstico no local, orçamento transparente e garantia.",
