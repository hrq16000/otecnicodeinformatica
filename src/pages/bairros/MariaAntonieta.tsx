...
const data = {
  ...
  metaDescription: "Técnico de informática no Maria Antonieta, Pinhais. Formatação, conserto de notebook, remoção de vírus, upgrade SSD. Atendimento a domicílio. A partir de R$ 69,99.",
  h1: "Técnico de Informática no Maria Antonieta – Pinhais",
  subtitulo: "Atendimento técnico profissional a domicílio no Maria Antonieta. Diagnóstico no local, orçamento transparente e garantia.",
  descricaoLonga: `O Maria Antonieta é um bairro de Pinhais, cidade vizinha de Curitiba com acesso rápido pela região norte/leste. Com forte perfil residencial, o bairro conta com demanda constante por serviços de informática. Nosso técnico de informática atende o Maria Antonieta a domicílio com equipamento profissional, realizando diagnóstico no local e resolvendo a maioria dos problemas na primeira visita. Para casos que exigem bancada, oferecemos coleta e entrega. Trabalhamos com transparência total: orçamento antes da execução, sem surpresas.`,
