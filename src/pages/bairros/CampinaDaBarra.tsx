...
const data = {
  ...
  metaDescription: "Técnico de informática no Campina da Barra, Araucária. Formatação, conserto de notebook, remoção de vírus, upgrade SSD. Atendimento a domicílio rápido. A partir de R$ 69,99.",
