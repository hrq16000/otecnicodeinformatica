...
const data = {
  ...
  slug: "alto-da-gloria",
  cidade: "Curitiba",
  metaTitle: "Técnico de Informática no Alto da Glória | Curitiba | Técnico Curitiba",
  metaDescription: "Técnico de informática no Alto da Glória, Curitiba. Atendimento a domicílio com diagnóstico no local. Formatação, conserto de notebook, redes Wi-Fi. A partir de R$ 69,99.",
