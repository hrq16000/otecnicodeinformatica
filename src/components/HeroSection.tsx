...
export const HeroSection = () => {
  ...
  return (
    ...
    <section className="hero-gradient pt-16 pb-14 md:pt-14 md:pb-18 lg:pt-16 lg:pb-24 relative overflow-hidden noise-overlay" aria-label="Técnico de informática em Curitiba">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-14 items-center">
          ...
          <div className="flex justify-center lg:justify-end order-1 lg:order-2 opacity-0 animate-[heroScale_0.7s_ease-out_0.15s_forwards]">
            <div className="relative group">
              ...
              <div className="absolute -top-3 -left-3 bg-card text-foreground px-3 py-2 rounded-lg shadow-lg flex items-center gap-1 hover:scale-110 transition-transform duration-300">
