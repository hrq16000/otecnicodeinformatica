          ...
          <div className="container mx-auto">
            <div className="max-w-4xl mx-auto -mt-8 relative z-20">
              <div className="rounded-xl overflow-hidden shadow-2xl">
                <SmartImage wrapperClassName="w-full" priority src={IMAGES.placaMae} alt={IMAGES.placaMaeAlt} className="w-full h-48 md:h-64 object-cover"  width="800" height="400" />
              </div>
            </div>
          </div>
        </section>
