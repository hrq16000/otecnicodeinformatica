...
const data = {
  ...
  metaDescription: "Técnico de informática no Rio Pequeno, São José dos Pinhais. Formatação, conserto de notebook, remoção de vírus, upgrade SSD. Atendimento a domicílio. A partir de R$ 69,99.",
  ...
  descricaoLonga: `O Rio Pequeno é um bairro de São José dos Pinhais, a segunda maior cidade do Paraná. Com milhares de residências e empresas, a região tem forte demanda por serviços de informática profissional. Nosso técnico de informática atende o Rio Pequeno a domicílio com equipamento profissional, realizando diagnóstico no local e resolvendo a maioria dos problemas na primeira visita. Para casos que exigem bancada, oferecemos coleta e entrega. Trabalhamos com transparência total: orçamento antes da execução, sem surpresas.`,
