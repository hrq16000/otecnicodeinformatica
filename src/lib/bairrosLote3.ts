...
export const BAIRROS_LOTE_3: Record<string, BairroLocalData> = {
  ...
  aviacao: {
    ...
    faqLocal: [
      ...
      { question: "Existe endereço fixo de atendimento no Aviação?", answer: "Não. O atendimento é agendado e acontece no seu endereço, por acesso remoto ou com coleta para bancada. Não anunciamos ponto físico nem técnico residente na região." },
