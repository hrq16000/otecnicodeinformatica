...
const data = {
  ...
  slug: "chapada",
  cidade: "Araucária",
  metaTitle: "Técnico de Informática no Chapada | Araucária | Atendimento a Domicílio | O Técnico de Informática",
  ...
  subtitulo: "Atendimento técnico profissional a domicílio no Chapada. Diagnóstico no local, valor transparente e garantia.",
