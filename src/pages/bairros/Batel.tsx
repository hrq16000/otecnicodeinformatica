...
const data = {
  ...
  metaDescription: "Técnico de informática no Batel, Curitiba. Atendimento para residências e empresas. Serviço profissional com garantia. Visita técnica a partir de R$99,99.",
