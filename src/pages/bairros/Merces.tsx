...
const data = {
  ...
  metaDescription: "Técnico de informática no Mercês, Curitiba. Formatação, conserto de notebook, remoção de vírus, upgrade SSD. Atendimento a domicílio rápido. A partir de R$ 69,99.",
  h1: "Técnico de Informática no Mercês – Curitiba",
  subtitulo: "Atendimento técnico profissional a domicílio no Mercês. Diagnóstico no local, orçamento transparente e garantia.",
