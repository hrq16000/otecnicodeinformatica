...
const WeissopolisPinhais = () => {
  const data = {
    ...
    metaDescription:
      "Técnico de informática no Weissópolis, Pinhais. Conserto de notebook e PC, formatação, vírus, upgrade SSD e redes Wi‑Fi. Atendimento a domicílio rápido. a partir de R$ 99,99.",
