      ...
      <BrowserRouter>
        ...
        <Suspense fallback={<RouteLoader />}>
          <Routes>
            ...
            <Route path="/servicos/pc-gamer" element={<ServicoCore slug="pc-gamer" />} />
            ...
            <Route path="/problemas/computador-nao-da-imagem" element={<ClusterProblemaPage />} />
            <Route path="/problemas/cheiro-de-queimado" element={<ClusterProblemaPage />} />
            <Route path="/problemas/notebook-molhado" element={<ClusterProblemaPage />} />
            <Route path="/problemas/windows-nao-inicia" element={<ClusterProblemaPage />} />
            <Route path="/problemas/computador-esquentando" element={<ClusterProblemaPage />} />
            <Route path="/problemas/impressora-nao-imprime" element={<ClusterProblemaPage />} />
            <Route path="/problemas/teclado-notebook-nao-funciona" element={<ClusterProblemaPage />} />
            ...
            <Route path="/admin/auditoria-local" element={<AdminAuditoriaLocal />} />
            <Route path="/admin/gates-locais" element={<AdminGatesLocais />} />
            ...
            <Route path="/admin/link-builder" element={<AdminLinkBuilder />} />
            <Route path="/admin/experimento-wa" element={<AdminExperimentoWa />} />
            ...
            <Route path="/admin/qa-trafego" element={<AdminQaTrafego />} />
