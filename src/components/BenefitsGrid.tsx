        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
          {benefits.map((benefit, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-card rounded-xl p-6 border border-border/50 shadow-[var(--shadow-sm)] hover:shadow-[var(--shadow-md)] hover:border-accent/20 transition-all duration-300 hover:-translate-y-0.5 text-center anim-scale ripple-container"
