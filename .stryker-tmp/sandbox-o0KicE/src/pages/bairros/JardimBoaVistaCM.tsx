...
const data = {
  ...
  descricaoLonga: `O Jardim Boa Vista é uma localidade de Campo Magro, cidade ao noroeste de Curitiba. Com cerca de 30 mil habitantes e perfil misto entre urbano e rural, o bairro conta com nosso atendimento profissional. Nosso técnico de informática atende o Jardim Boa Vista a domicílio com equipamento profissional, realizando diagnóstico no local e resolvendo a maioria dos problemas na primeira visita. Para casos que exigem bancada, oferecemos coleta e entrega. Trabalhamos com transparência total: Valor antes da execução, sem surpresas.`,
