...
const CFTVSaoJosePinhais = () => (
  <CFTVCityTemplate
    ...
    metaDescription="Kit 4 câmeras Intelbras com instalação profissional em São José dos Pinhais. Acesso remoto pelo celular. R$ 1.350 completo. Desde 1999. WhatsApp (41) 99745-2053."
