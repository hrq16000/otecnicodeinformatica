        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
            {perfis.map((p, i) => {
              const Icon = p.icon;
              return (
                <div key={i} className="bg-secondary rounded-xl p-4 md:p-5 hover:shadow-[var(--shadow-lg)] hover:-translate-y-2 transition-all duration-300 border border-transparent hover:border-accent/20 group slide-up-stagger" style={{ animationDelay: `${i * 80}ms` }}>
