...
const CFTVGuaratuba = () => (
  <CFTVCityTemplate
    ...
    metaDescription="Kit 4 câmeras Intelbras com instalação em Guaratuba. Monitore sua casa de praia pelo celular de qualquer lugar. R$ 1.350 completo. WhatsApp."
