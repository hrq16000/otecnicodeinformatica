...
- **Emsisoft Decryptor**: ferramentas para dezenas de variantes`,
  ...
  // ==================== NOTEBOOK SEM WEBCAM ====================
  {
    ...
    heading: "Notebook Sem Webcam Funcionando em Curitiba",
    subheading: "Diagnóstico e reparo de câmera integrada — driver, cabo flat ou módulo defeituoso",
    breadcrumbLabel: "Webcam Não Funciona",
    descricaoProblema: `A webcam integrada do notebook parou de funcionar ou não é detectada pelo sistema. O problema pode aparecer como "câmera não encontrada", tela preta em aplicativos de vídeo, LED da câmera não acende, ou a webcam simplesmente desapareceu do Gerenciador de Dispositivos.\n\nEm Curitiba, com o aumento do trabalho remoto e reuniões online, esse problema impacta diretamente a produtividade. As causas variam desde configurações de privacidade do Windows até falha física do módulo da câmera.`,
    sintomas: [
      "Webcam não aparece no Gerenciador de Dispositivos",
      "Tela preta em aplicativos como Zoom, Teams ou Google Meet",
      "LED da câmera não acende ao abrir aplicativos de vídeo",
      "Mensagem 'Não foi possível encontrar sua câmera' no Windows",
      "Webcam funciona intermitentemente — liga e desliga sozinha",
      "Imagem da câmera congelada ou com linhas horizontais",
      "Erro 0xA00F4244 ao tentar usar a câmera",
    ],
    causas: [
      "**Configurações de Privacidade**: O Windows 10/11 tem opções que bloqueiam o acesso à câmera por aplicativos",
      "**Driver corrompido ou ausente**: Atualizações do Windows podem remover ou corromper o driver da webcam",
      "**Cabo flat desconectado**: Em notebooks que sofreram queda ou tiveram a tela aberta para reparo",
      "**Módulo da câmera defeituoso**: Falha no hardware do sensor CMOS da webcam",
      "**Antivírus bloqueando**: Alguns antivírus possuem proteção de webcam que impede o acesso",
      "**Conflito de software**: Dois aplicativos tentando usar a câmera simultaneamente",
      "**Tampa de privacidade física**: Slider de privacidade fechado (comum em notebooks corporativos)",
    ],
    riscos: [
    ...
    relatedPages: [
      ...
      { to: "/servicos/conserto-pc-notebook", label: "Conserto de Notebook" },
      { to: "/notebook-tela-preta-curitiba", label: "Tela Preta" },
      { to: "/diagnostico-tecnico", label: "Diagnóstico Técnico" },
    ]
  },
  ...
  // ==================== ERRO 0xC00000E ====================
  {
    ...
    heading: "Erro 0xc00000e — PC Não Inicia em Curitiba",
    subheading: "Reparo do Boot Configuration Data (BCD) e restauração da inicialização do Windows",
    breadcrumbLabel: "Erro 0xc00000e",
    descricaoProblema: `O erro 0xc00000e é uma das telas azuis mais comuns que impedem o Windows de iniciar. Ele indica que o Boot Configuration Data (BCD) — o arquivo que diz ao sistema onde encontrar o Windows no disco — está corrompido, ausente ou referenciando uma partição incorreta.\n\nEm Curitiba, atendemos esse erro frequentemente após atualizações do Windows que falharam, clonagem de disco mal feita, ou quando o usuário adicionou/removeu um segundo HD/SSD sem reconfigurar o boot. A tela exibe "Seu PC precisa ser reparado" com o código 0xc000000e.`,
    sintomas: [
      "Tela azul com código 0xc000000e ao ligar o PC",
      "Mensagem 'Seu PC/dispositivo precisa ser reparado'",
      "Windows não inicia mesmo após múltiplas reinicializações",
      "Erro apareceu após atualização do Windows",
      "Problema surgiu depois de clonar o disco ou trocar SSD",
      "Tela de recuperação aparece em loop infinito",
      "Boot manager não encontra o sistema operacional",
    ],
    causas: [
      "**BCD corrompido**: O arquivo de configuração de boot foi danificado por desligamento forçado ou falha de energia",
      "**Clonagem de disco incorreta**: Ao migrar para SSD, a partição EFI/boot não foi clonada corretamente",
      "**Atualização do Windows falhou**: Update interrompido corrompeu os arquivos de inicialização",
      "**Ordem de boot alterada**: BIOS/UEFI está tentando iniciar pelo disco errado",
      "**Partição EFI danificada**: A partição de sistema EFI (100-500MB) foi modificada ou formatada acidentalmente",
      "**Setores defeituosos no disco**: Área do disco onde o BCD está armazenado possui bad blocks",
      "**Segundo disco removido**: O BCD estava no disco removido e o Windows perdeu a referência",
    ],
    riscos: [
  ...
  // ==================== PC COM TELA CONGELADA ====================
  {
    ...
    heading: "PC com Tela Congelada em Curitiba",
    subheading: "Diagnóstico completo de travamentos — hardware, software e superaquecimento",
    breadcrumbLabel: "Tela Congelada",
    descricaoProblema: `O computador congela completamente — o mouse para, o teclado não responde e a única saída é forçar o desligamento pelo botão de energia. Esse problema pode ser aleatório ou ocorrer em situações específicas como ao abrir programas pesados, jogar ou após um tempo de uso.\n\nEm Curitiba, diagnosticamos centenas de casos de tela congelada. As causas mais comuns são superaquecimento (especialmente em dias quentes ou notebooks com ventilação obstruída), memória RAM defeituosa, disco rígido com setores defeituosos e drivers de vídeo incompatíveis.`,
    sintomas: [
      "Tela congela completamente — mouse e teclado não respondem",
      "Computador trava aleatoriamente durante o uso",
      "Congelamento ocorre sempre ao usar programas específicos",
      "Tela congela durante jogos ou tarefas pesadas",
      "PC trava após alguns minutos de uso e precisa ser desligado forçado",
      "Travamento acompanhado de som repetitivo (áudio em loop)",
      "Tela congela mas o LED do HD/SSD continua piscando",
    ],
    causas: [
      "**Superaquecimento**: Pasta térmica seca, cooler obstruído ou ventilação insuficiente fazem o processador throttle e congelar",
      "**Memória RAM defeituosa**: Módulos com erros intermitentes causam travamentos aleatórios",
      "**Disco rígido com setores defeituosos**: HD mecânico com bad blocks congela ao tentar ler áreas danificadas",
      "**Driver de vídeo incompatível**: Driver da GPU corrompido ou versão incompatível com o Windows",
      "**Fonte de alimentação instável**: Fonte fornecendo voltagem irregular causa travamentos sob carga",
      "**Capacitores estufados na placa-mãe**: Capacitores danificados causam instabilidade geral",
      "**Conflito de software**: Antivírus, programas em segundo plano ou malware consumindo recursos",
    ],
    riscos: [
    ...
    relatedPages: [
      { to: "/computador-lento-curitiba", label: "PC Lento" },
      { to: "/tela-azul-bsod-curitiba", label: "Tela Azul (BSOD)" },
      { to: "/computador-superaquecendo-curitiba", label: "Superaquecimento" },
      { to: "/servicos/conserto-pc-notebook", label: "Conserto de PC" },
    ]
  },
  ...
  // ==================== COMPUTADOR MUITO BARULHENTO ====================
  {
    ...
    heading: "Computador Muito Barulhento em Curitiba",
    subheading: "Diagnóstico e solução de ruídos anormais — coolers, HD mecânico e vibrações",
    breadcrumbLabel: "Computador Barulhento",
    descricaoProblema: `O computador começou a fazer barulho excessivo — ventoinhas girando em alta rotação, sons de clique, zumbido constante ou vibração. Esse problema vai além do incômodo: ruídos anormais frequentemente indicam que algum componente está falhando ou que o sistema está superaquecendo.\n\nEm Curitiba, diagnosticamos que a maioria dos computadores barulhentos sofre de acúmulo de poeira nos coolers (que força rotações mais altas para compensar), rolamentos desgastados em ventoinhas, ou HD mecânico com falha iminente emitindo sons de clique.`,
    sintomas: [
      "Ventoinhas giram em alta rotação constantemente",
      "Sons de clique rítmico vindos do HD",
      "Zumbido ou vibração constante do gabinete",
      "Barulho aumenta ao abrir programas ou jogos",
      "Ventoinha faz barulho de raspagem ou ranger",
      "Notebook parece um 'secador de cabelo' ao ligar",
      "Ruído de bobina (coil whine) vindo da placa de vídeo ou fonte",
    ],
    causas: [
      "**Acúmulo de poeira nos coolers**: Poeira obstrui as aletas do dissipador, forçando rotações mais altas",
      "**Rolamento desgastado**: Ventoinhas com rolamento gasto produzem ruído de raspagem ou vibração",
      "**HD mecânico com falha**: Sons de clique indicam que as cabeças de leitura estão com dificuldade — falha iminente",
      "**Pasta térmica seca**: Sem transferência térmica eficiente, o cooler precisa girar mais rápido",
      "**Curva de ventoinha agressiva**: BIOS configurada para manter ventoinhas em alta rotação",
      "**Vibração do gabinete**: Parafusos soltos, painéis desencaixados ou HD sem borrachas anti-vibração",
      "**Coil whine**: Vibração de componentes eletrônicos (indutores) em placas de vídeo ou fontes sob carga",
    ],
    riscos: [
    ...
    relatedPages: [
      { to: "/computador-superaquecendo-curitiba", label: "Superaquecimento" },
      { to: "/computador-lento-curitiba", label: "PC Lento" },
      { to: "/hd-fazendo-barulho-curitiba", label: "HD com Barulho" },
      { to: "/servicos/upgrade-ssd-memoria", label: "Upgrade SSD" },
    ]
  },
];
