...
const data = {
  ...
  slug: "xaxim",
  cidade: "Curitiba",
  metaTitle: "Técnico de Informática no Xaxim | Curitiba | Atendimento a Domicílio | Técnico Curitiba",
  metaDescription: "Técnico de informática no Xaxim, Curitiba. Formatação, conserto de notebook, remoção de vírus, upgrade SSD. Atendimento a domicílio rápido. A partir de R$ 69,99.",
