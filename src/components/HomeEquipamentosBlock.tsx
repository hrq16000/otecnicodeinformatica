        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4 mb-8">
            {equipamentos.map((eq, i) => {
              const Icon = eq.icon;
              return (
                <div key={i} className="bg-secondary rounded-xl p-4 text-center border border-transparent hover:border-accent/15 hover:shadow-[var(--shadow-md)] hover:-translate-y-1.5 hover:scale-[1.03] transition-all duration-300 group animated-border stagger-item" style={{ animationDelay: `${i * 80}ms` }}>
                  <div className="bg-primary rounded-lg p-2 w-fit mx-auto mb-2 group-hover:bg-accent group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
