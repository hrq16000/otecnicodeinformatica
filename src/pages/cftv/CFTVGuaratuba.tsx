...
const CFTVGuaratuba = () => (
  <CFTVCityTemplate
    city="Guaratuba"
    slug="guaratuba"
    metaTitle="Câmeras de Segurança em Guaratuba | Kit 4 Câmeras Intelbras R$ 1.350 | Instalação Profissional"
    metaDescription="Kit 4 câmeras Intelbras com instalação em Guaratuba. Monitore sua casa de praia pelo celular de qualquer lugar. R$ 1.350 completo. WhatsApp (41) 99745-2053."
