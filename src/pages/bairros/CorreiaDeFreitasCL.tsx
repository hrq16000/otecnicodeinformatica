...
const data = {
  ...
  cidade: "Campo Largo",
  metaTitle: "Técnico de Informática no Correia de Freitas | Campo Largo | Atendimento Domicílio | O Técnico de Informática",
  ...
  subtitulo: "Atendimento técnico profissional a domicílio no Correia de Freitas. Diagnóstico no local, valor transparente e garantia.",
  descricaoLonga: `O Correia de Freitas é uma região de Campo Largo, a Capital da Louça, com perfil residencial e comercial. Moradores e empresas locais precisam de suporte técnico rápido e confiável. Nosso técnico de informática atende o Correia de Freitas a domicílio com equipamento profissional, realizando diagnóstico no local e resolvendo a maioria dos problemas na primeira visita. Para casos que exigem bancada, oferecemos coleta e entrega. Trabalhamos com transparência total: Valor antes da execução, sem surpresas.`,
