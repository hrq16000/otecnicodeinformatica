...
const data = {
  ...
  metaDescription: "Técnico de informática no Jardim Paraíso, Almirante Tamandaré. Formatação, conserto de notebook, remoção de vírus, upgrade SSD. Atendimento a domicílio. A partir de R$ 69,99.",
